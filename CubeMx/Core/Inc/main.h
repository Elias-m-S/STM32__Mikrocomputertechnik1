...
/* Private defines -----------------------------------------------------------*/
#define B1_Input_Irq_Pin GPIO_PIN_13
#define B1_Input_Irq_GPIO_Port GPIOC
#define B1_Input_Irq_EXTI_IRQn EXTI15_10_IRQn
#define SEG_F_Pin GPIO_PIN_0
#define SEG_F_GPIO_Port GPIOC
#define SEG_G_Pin GPIO_PIN_1
#define SEG_G_GPIO_Port GPIOC
#define R1_ADC_INPUT_Pin GPIO_PIN_0
#define R1_ADC_INPUT_GPIO_Port GPIOA
#define R2_ADC_INPUT_Pin GPIO_PIN_1
#define R2_ADC_INPUT_GPIO_Port GPIOA
...
#define SW1_Input_Irq_Pin GPIO_PIN_10
#define SW1_Input_Irq_GPIO_Port GPIOA
#define SW1_Input_Irq_EXTI_IRQn EXTI15_10_IRQn
#define LED_D0_Pin GPIO_PIN_5
#define LED_D0_GPIO_Port GPIOB
#define LED_D4_Pin GPIO_PIN_8
